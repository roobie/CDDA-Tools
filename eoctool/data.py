...
class AndCondition(Condition):
    and_: List[Union[Condition, Dict]] = field(
        default_factory=list, metadata={"json_key": "and"}
    )


@dataclass
class OrCondition(Condition):
    or_: List[Union[Condition, Dict]] = field(
        default_factory=list, metadata={"json_key": "or"}
    )
